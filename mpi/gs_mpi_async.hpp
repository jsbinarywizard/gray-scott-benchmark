...
private:
    ...
    static StridedRow pack_subview(int dir, const View& field, std::size_t r, std::size_t c) {
        switch (dir) {
    ...
    static StridedRow halo_subview(int dir, View& field, std::size_t r, std::size_t c) {
        switch (dir) {
    ...
    void iteration() override {
        ...
        this->communication_seconds += recv_timer.elapsed();
        ...
        end_sends(u_handle);
        end_sends(v_handle);
        this->communication_seconds += send_timer.elapsed();
